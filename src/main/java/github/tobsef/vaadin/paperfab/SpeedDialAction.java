...
public class SpeedDialAction extends Label implements HasEnabled {
    ...
    /**
     * @param color The background color of the Floating Action Button when focused
     */
    ...
    /**
     * @param color The background color of label
     */
    ...
    /**
     * @param color The text color of label
     */
    ...
    /**
     * @param color The background color of the Floating Action Button when opened
     */
    ...
    /**
     * @param color The background color of the Floating Action Button when opened and focused
     */
    ...
    /**
     * @param positionMode The type of positioning method used for the Floating Action Button (default: absolute)
     */
    ...
    /**
     * @param marginBottom Margin to the bottom of the screen (default: 16px)
     */
